...
## Why should R users care? {.smaller}
...
- Automatic differentiation. It's straightforward to write GLM models in TensorFlow by varying the activation and loss functions (link functions and likelihood in GLM)

- Built in optimization algorithms (SGD, Adam) that don't require that all data is in RAM
...
## What is deep learning? | A subfield of machine learning, which is in turn a subfield of AI

<img src="images/ai-ml-dl.png" width=675  style="margin-top: -38px;"/>


## What is machine learning? | Learning model parameters via exposure to many example data points
...
## Statistical modeling vs. machine learning | A difference in orientation

- **Statistics**: Infer the process by which you data was generated.

- **Machine learning**: Predict future data with respect to some variable.
...
- Traditional optimization algorithms update weights by averaging the gradients for all data points. To economize computational cost we use [stochastic gradient descent](https://en.wikipedia.org/wiki/Stochastic_gradient_descent) and only calculate gradients for a small sample of the data. 
...
## TensorFlow Keras API | High level API for nueral networks <br/> <https://tensorflow.rstudio.com/keras/> {.smaller}
...
## Thank you! | https://tensorflow.rstudio.com
