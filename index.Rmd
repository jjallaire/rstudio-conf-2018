...
## RStudio Server with TensorFlow-GPU for AWS | https://tensorflow.rstudio.com/tools/cloud_server_gpu.html#amazon-ec2

<div>
<img src="images/aws-marketplace.png" width=450 align=left class="illustration" style=" margin-right: 50px;" />

- R and RStudio Server pre-installed and configured to work with TensorFlow

- NVIDIA CUDA and cuDNN GPU libraries 

- TensorFlow and Keras libraries 

- R for TensorFlow packages and Tidyverse packages 
</div>
