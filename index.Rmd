...
## Why a dataflow graph? | Major gains in performance, scalability, and portability
...
- Loss function (measures performance of model, e.g. *categorical cross entropy*)
...
## Statistical modeling vs. machine learning | <span style="font-size: 0.8em; margin-top: -38px;"><https://stats.stackexchange.com/questions/6/the-two-cultures-statistics-vs-machine-learning></span>
...
<div class="columns-2" style="margin-top: -25px">
<img src="images/timeseries-frontier-2.png" width=450 class="illustration" />
...
<img src="images/rstudio-keras-demo.png" class=illustration style="margin-top: -38px;" width=800/>
...
<img src="images/dense-network.png" width=900 class="illustration"/>
...
## Additional talks | interop track at 11am

- *Large scale machine learning using TensorFlow, BigQuery and CloudML* (Michael Quinn)---Demonstrate modeling predictions on Google Store data plus details of an upcoming Kaggle contest for R users.

- *Deploying TensorFlow models with tfdeploy* (Javier Luraschi). Demonstrate various ways to deploy Keras and TensorFlow models including deploying into a web browser with [Keras.js](https://transcranial.github.io/keras-js).
