...
- Since neural networks can have millions of coefficients, it's not practical to compute the gradient-based updates analytically. Instead, we use [stochastic gradient descent](https://en.wikipedia.org/wiki/Stochastic_gradient_descent).
